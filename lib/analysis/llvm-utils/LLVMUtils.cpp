...
//
//        return vanguard::UnitFactory::getInstance()->createVal(fun->unwrap()->getArg(i));
//    }
...
//        auto factory = vanguard::UnitFactory::getInstance();
//
...
//    bool LLVMUtils::readsMemFrom(const vanguard::Universe::Instruction *instr, const vanguard::Value *obj) {
//        if (auto src = isMemRead(instr))
//            return dependsOnValue(src, obj->unwrap());
//        return false;
//    }

//    bool LLVMUtils::writesMemTo(const vanguard::Universe::Instruction *instr, const vanguard::Value *obj) {
//        if (auto dest = isMemWrite(instr))
//            return dependsOnValue(dest, obj->unwrap());
//        return false;
//    }

//    std::string LLVMUtils::demangleFunction(const llvm::Function *fun){
...
//    bool LLVMUtils::returnDependsOnVal(const vanguard::Universe::Function *fun, const vanguard::Value *val) {
//        auto llvmFun = fun->unwrap();
//
...
//    bool LLVMUtils::valueDependsOn(const vanguard::Value *src, const vanguard::Universe::Instruction *instr) {
