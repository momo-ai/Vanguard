...
namespace vanguard {
    ...
    Universe::Instruction *BlockchainFactory::createIns(const llvm::Instruction *ins)  {
        ...
        if (instructionMap.find(ins) == instructionMap.end()) {
            ...
            if (opcode == 1) instructionMap[ins] = new ReturnIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::ReturnInst>(ins));
            else if (opcode == 2) instructionMap[ins] = new BranchIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::BranchInst>(ins));
            else if (opcode == 3)  instructionMap[ins] = new SwitchIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::SwitchInst>(ins));
            else if (opcode == 4) instructionMap[ins] = new IndirectBrIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::IndirectBrInst>(ins));
            else if (opcode == 7) instructionMap[ins] = new UnreachableIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::UnreachableInst>(ins));
            else if (opcode == 12) instructionMap[ins] = new UnaryIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::UnaryOperator>(ins));
            else if (opcode >= 13 && opcode <= 30) instructionMap[ins] = new BinaryIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::BinaryOperator>(ins));
            else if (opcode == 31) instructionMap[ins] = new AllocaIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::AllocaInst>(ins));
            else if (opcode == 32) instructionMap[ins] = new LoadIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::LoadInst>(ins));
            else if (opcode == 33)  instructionMap[ins] = new StoreIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::StoreInst>(ins));
            else if (opcode == 34) instructionMap[ins] = new GetElementPtrIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::GetElementPtrInst>(ins));
            else if (opcode >= 38 && opcode <= 50) instructionMap[ins] = new CastIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::CastInst>(ins));
            else if (opcode == 53 || opcode == 54) instructionMap[ins] = new CmpIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::CmpInst>(ins));
            else if (opcode == 55) instructionMap[ins] = new PHIIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::PHINode>(ins));
            else if (opcode == 56) instructionMap[ins] = new CallIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::CallBase>(ins));
            else if (opcode == 57) instructionMap[ins] = new SelectIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::SelectInst>(ins));
            else if (opcode == 61) instructionMap[ins] = new ExtractElementIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::ExtractElementInst>(ins));
            else if (opcode == 62) instructionMap[ins] = new InsertElementIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::InsertElementInst>(ins));
            else if (opcode == 63) instructionMap[ins] = new ShuffleVectorIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::ShuffleVectorInst>(ins));
            else if (opcode == 64) instructionMap[ins] = new ExtractValueIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::ExtractValueInst>(ins));
            else if (opcode == 65) instructionMap[ins] = new InsertValueIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::InsertValueInst>(ins));
            else if (opcode == 67) instructionMap[ins] = new FreezeIns<Top<Blockchain<Universe>>>(*this,*llvm::dyn_cast<llvm::FreezeInst>(ins));
