...
namespace vanguard {
    ...
    Blockchain<Universe>::Contract *SummaryReader::readContract(rapidjson::Value &val) {
        ...
        vector<Top<Blockchain<Universe>>::Function *> functions = {};
    ...
    Top<Blockchain<Universe>>::Function *SummaryReader::readFunction(std::string contractName, rapidjson::Value &val) {
        require(val.HasMember("name") && val["name"].IsString(), "Function must have a name");
