...
namespace vanguard{
    ...
    Universe::Instruction *LLVMFactory::createIns(const llvm::Instruction *ins)  {
        ...
        if (instructionMap.find(ins) == instructionMap.end()) {
            ...
            if (opcode == 1) instructionMap[ins] = new Universe::ReturnIns<Top<Universe>, llvm::ReturnInst>(llvm::dyn_cast<llvm::ReturnInst>(ins), *this);
            else if (opcode == 2) instructionMap[ins] = new Universe::BranchIns<Top<Universe>, llvm::BranchInst>(llvm::dyn_cast<llvm::BranchInst>(ins), *this);
            else if (opcode == 3)  instructionMap[ins] = new Universe::BranchIns<Top<Universe>, llvm::SwitchInst>(llvm::dyn_cast<llvm::SwitchInst>(ins), *this);
            else if (opcode == 4) instructionMap[ins] = new Universe::BranchIns<Top<Universe>, llvm::IndirectBrInst>(llvm::dyn_cast<llvm::IndirectBrInst>(ins), *this);
            else if (opcode == 7) instructionMap[ins] = new Universe::ErrorIns<Top<Universe>, llvm::UnreachableInst>(llvm::dyn_cast<llvm::UnreachableInst>(ins), *this);
            else if (opcode == 12) instructionMap[ins] = new Universe::UnaryOpIns<Top<Universe>, llvm::UnaryOperator>(llvm::dyn_cast<llvm::UnaryOperator>(ins), *this);
            else if (opcode >= 13 && opcode <= 30) instructionMap[ins] = new Universe::BinaryOpIns<Top<Universe>, llvm::BinaryOperator>(llvm::dyn_cast<llvm::BinaryOperator>(ins), *this);
            else if (opcode == 31) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::AllocaInst>(llvm::dyn_cast<llvm::AllocaInst>(ins), *this);
            else if (opcode == 32) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::LoadInst>(llvm::dyn_cast<llvm::LoadInst>(ins), *this);
            else if (opcode == 33)  instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::StoreInst>(llvm::dyn_cast<llvm::StoreInst>(ins), *this);
            else if (opcode == 34) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::GetElementPtrInst>(llvm::dyn_cast<llvm::GetElementPtrInst>(ins), *this);
            else if (opcode >= 38 && opcode <= 50) instructionMap[ins] = new Universe::CastIns<Top<Universe>, llvm::CastInst>(llvm::dyn_cast<llvm::CastInst>(ins), *this);
            else if (opcode == 53 || opcode == 54) instructionMap[ins] = new Universe::BinaryOpIns<Top<Universe>, llvm::CmpInst>(llvm::dyn_cast<llvm::CmpInst>(ins), *this);
            else if (opcode == 55) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::PHINode>(llvm::dyn_cast<llvm::PHINode>(ins), *this);
            else if (opcode == 56) instructionMap[ins] = new Universe::CallIns<Top<Universe>, llvm::CallBase>(llvm::dyn_cast<llvm::CallBase>(ins), *this);
            else if (opcode == 57) instructionMap[ins] = new Universe::TernaryIns<Top<Universe>, llvm::SelectInst>(llvm::dyn_cast<llvm::SelectInst>(ins), *this);
            else if (opcode == 61) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::ExtractElementInst>(llvm::dyn_cast<llvm::ExtractElementInst>(ins), *this);
            else if (opcode == 62) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::InsertElementInst>(llvm::dyn_cast<llvm::InsertElementInst>(ins), *this);
            else if (opcode == 63) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::ShuffleVectorInst>(llvm::dyn_cast<llvm::ShuffleVectorInst>(ins), *this);
            else if (opcode == 64) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::ExtractValueInst>(llvm::dyn_cast<llvm::ExtractValueInst>(ins), *this);
            else if (opcode == 65) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::InsertValueInst>(llvm::dyn_cast<llvm::InsertValueInst>(ins), *this);
            else if (opcode == 67) instructionMap[ins] = new Universe::UnknownIns<Top<Universe>, llvm::FreezeInst>(llvm::dyn_cast<llvm::FreezeInst>(ins), *this);
